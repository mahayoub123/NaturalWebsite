    ...
    <section className="min-h-screen flex items-center justify-center bg-[white] text-black px-4">
      <div className="w-full max-w-md bg-[white]/80 backdrop-blur-md rounded-2xl shadow-lg p-8 relative">
        <div className="text-center mb-8">
          <h1 className=" font-open text-[black] text-3xl font-semibold mb-2">
            Login
          </h1>
          <p className="  font-open text-gray-400 text-sm">
        ...
        <form className="flex flex-col gap-5">
          ...
          <div className="text-right">
            <a
              href="#"
              className="text-sm text-[#FA8B02] hover:underline transition"
            >
              Forgot Password?
            </a>
          </div>
